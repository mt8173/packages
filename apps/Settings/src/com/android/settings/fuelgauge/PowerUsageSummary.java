...
public class PowerUsageSummary extends PowerUsageBase {
    ...
    public void onResume() {
        ...
        refreshStats();
		updateBatteryPct();
		getContext().getContentResolver().registerContentObserver(Settings.Global.getUriFor(SHOW_PERCENT_SETTING), false, mSettingObserver);		
    }
	...
	public final String SHOW_PERCENT_SETTING = "show_percentage";
	
	private final OnPreferenceChangeListener mBatteryPctChange = new OnPreferenceChangeListener() {
		@Override
		public boolean onPreferenceChange(Preference preference, Object newValue) {
			final boolean v = (Boolean) newValue;
			Settings.Global.putInt(getContext().getContentResolver(), SHOW_PERCENT_SETTING, v?1:0);
 			return true;
		}
	};
	...
	private void updateBatteryPct() {
		...
		mBatteryPct.setChecked(Settings.Global.getInt(getContext().getContentResolver(),
