    ...
    implements  MusicUtils.Defs
{
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        final AdapterContextMenuInfo mi = (AdapterContextMenuInfo) menuInfoIn;
        ...
        if (mPlaylistCursor.getString(mPlaylistCursor.getColumnIndexOrThrow(
                MediaStore.Audio.Playlists.NAME)).equals("最近添加的歌曲")) {
        	 final String[] items = {getResources().getString( R.string.play_selection),
             		getResources().getString( R.string.edit_playlist_menu),
             		}; 
     		AlertDialog.Builder builder = new AlertDialog.Builder(PlaylistBrowserActivity.this);
     		builder.setTitle(mPlaylistCursor.getString(mPlaylistCursor.getColumnIndexOrThrow(
                     MediaStore.Audio.Playlists.NAME)));
     				...
     				switch (which) {
     				   case 0:
     		                if (mi.id == RECENTLY_ADDED_PLAYLIST) {
     		                    ...
     		                    MusicUtils.playPlaylist(PlaylistBrowserActivity.this, mi.id);
     		                }
     		                break;
     		            ...
     		            case 1:
     		                if (mi.id == RECENTLY_ADDED_PLAYLIST) {
     		                    ...
     		                    intent.setClass(PlaylistBrowserActivity.this, WeekSelector.class);
			...
			final String[] items = {getResources().getString( R.string.play_selection),
	        		getResources().getString( R.string.delete_playlist_menu),
	        		getResources().getString( R.string.rename_playlist_menu)}; 
			AlertDialog.Builder builder = new AlertDialog.Builder(PlaylistBrowserActivity.this);
			builder.setTitle(mPlaylistCursor.getString(mPlaylistCursor.getColumnIndexOrThrow(
	                MediaStore.Audio.Playlists.NAME)));
			builder.setItems(items, new DialogInterface.OnClickListener() {
					...
					switch (which) {
					   case 0:
			            ...
			            case 1:
			                ...
			                Toast.makeText(PlaylistBrowserActivity.this, R.string.playlist_deleted_message, Toast.LENGTH_SHORT).show();
			            ...
			            case 2:
			                Intent intent = new Intent();
			                intent.setClass(PlaylistBrowserActivity.this, RenamePlaylist.class);
