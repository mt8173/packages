        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        if (itemtype == ExpandableListView.PACKED_POSITION_TYPE_GROUP) {
            ...
            final String[] items = {getResources().getString( R.string.play_selection),
            		getResources().getString(  R.string.add_to_playlist),
            		getResources().getString( R.string.delete_item)}; 
			AlertDialog.Builder builder = new AlertDialog.Builder(ArtistAlbumBrowserActivity.this);
			if (mIsUnknownAlbum) {
				builder.setTitle(getString(R.string.unknown_album_name));
            } else {
            	builder.setTitle(mCurrentAlbumName);
            }
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					case 0:
		                ...
		                list =
		                    ...
		                    MusicUtils.getSongListForArtist(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentArtistId))
		                    : MusicUtils.getSongListForAlbum(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentAlbumId));
		                        
		                MusicUtils.playAll(ArtistAlbumBrowserActivity.this, list, 0);
						break;
					case 1:
						 list =
		                    mCurrentArtistId != null ?
		                    MusicUtils.getSongListForArtist(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentArtistId))
		                    : MusicUtils.getSongListForAlbum(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentAlbumId));
		                long playlist = getIntent().getLongExtra("playlist", 0);
		                MusicUtils.addToPlaylist(ArtistAlbumBrowserActivity.this, list, playlist);
						break;
					case 2:
			                String desc;
			                if (mCurrentArtistId != null) {
			                    list = MusicUtils.getSongListForArtist(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentArtistId));
			                    String f;
			                    ...
			                    list = MusicUtils.getSongListForAlbum(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentAlbumId));
			                    String f;
			                    if (android.os.Environment.isExternalStorageRemovable()) {
			                ...
			                intent.setClass(ArtistAlbumBrowserActivity.this, DeleteItems.class);
			                intent.putExtras(b);
          ...
          /*  if (mIsUnknownAlbum) {
            ...
            final String[] items = {getResources().getString( R.string.play_selection),
            		getResources().getString(  R.string.add_to_playlist),
            		getResources().getString( R.string.new_playlist),
            		getResources().getString( R.string.delete_item)};
			AlertDialog.Builder builder = new AlertDialog.Builder(ArtistAlbumBrowserActivity.this);
			if (mIsUnknownAlbum) {
				builder.setTitle(getString(R.string.unknown_album_name));
					 ...
					 case 0: {
			            ...
			            case 1: {
			                long [] list =
			                    ...
			                    MusicUtils.getSongListForArtist(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentArtistId))
			                    : MusicUtils.getSongListForAlbum(ArtistAlbumBrowserActivity.this, Long.parseLong(mCurrentAlbumId));
			                MusicUtils.addToCurrentPlaylist(ArtistAlbumBrowserActivity.this, list);
			                break ;
			            }
