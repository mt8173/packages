    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        String s=getResources().getString( R.string.play_selection);
			...
			public void onClick(DialogInterface dialog, int which) {
				  switch (which) {
		            case 0: {
		                ...
		                long [] list = MusicUtils.getSongListForAlbum(AlbumBrowserActivity.this, Long.parseLong(mCurrentAlbumId));
		                MusicUtils.playAll(AlbumBrowserActivity.this, list, 0);
		                break;
		            }

		            case 1: {
		                long [] list = MusicUtils.getSongListForAlbum(AlbumBrowserActivity.this, Long.parseLong(mCurrentAlbumId));
		                MusicUtils.addToCurrentPlaylist(AlbumBrowserActivity.this, list);
		                break;
		            }
		            ...
		            case 3: {
		                ...
		                Intent intent = new Intent();
		                intent.setClass(AlbumBrowserActivity.this, DeleteItems.class);
		                intent.putExtras(b);
