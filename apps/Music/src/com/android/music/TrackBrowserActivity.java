        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
			...
			public void onClick(DialogInterface dialog, int which) {
				 switch (which) {
		            case 0: {
		                ...
		                MusicUtils.playAll(TrackBrowserActivity.this, mTrackCursor, position);
		                break;
		            }

		            case 1: {
		                long [] list = new long[] { mSelectedId };
		                MusicUtils.addToCurrentPlaylist(TrackBrowserActivity.this, list);
		                break;
		            }
		            ...
		            //case 3:
		             ...
		             //   MusicUtils.setRingtone(TrackBrowserActivity.this, mSelectedId);
		             //   break;
		            ...
		            case 3: {
		                ...
		                Intent intent = new Intent();
		                intent.setClass(TrackBrowserActivity.this, DeleteItems.class);
		                intent.putExtras(b);
    ...
    {
        if (mTrackCursor.getCount() == 0||isLong) {
            return;
        }
