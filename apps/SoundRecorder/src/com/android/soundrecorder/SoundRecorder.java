...
public class SoundRecorder extends Activity 
    ...
    private void saveSample() {
		...
		String path =mRecorder.sampleFile().getAbsolutePath().toString();
		Toast.makeText(this,getResources().getString(R.string.save_success)+path, Toast.LENGTH_SHORT).show();
    }
