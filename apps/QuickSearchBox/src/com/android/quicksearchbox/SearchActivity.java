...
public class SearchActivity extends Activity {
    ...
    protected void onStop() {
        ...
        /// M: To avoid NullPointerException, adding safe check
        if (!mTookAction && null!=getCurrentSuggestions()) {
    ...
    protected SuggestionCursor getCurrentSuggestions() {
        /// M: To avoid NullPointerException, adding safe check @{
        if (null == mSearchActivityView){
            return null;
        }
        if (null == mSearchActivityView.getSuggestions()){
            return null;
        }
        if (null == mSearchActivityView.getSuggestions().getResult()){
            return null;
        }
      /// @}
