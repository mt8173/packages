    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_wallpaper:
                FilmstripItem data = mDataAdapter.getItemAt(mFilmstripController.getCurrentAdapterIndex());
				if(data==null)
					return true;
				MediaDetails details = data.getMediaDetails().get();
				for (Entry<Integer, Object> detail : details) {
					if(detail != null && detail.getKey().equals(MediaDetails.INDEX_PATH)){
						String path = detail.getValue().toString();
